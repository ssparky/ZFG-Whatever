...
GTCEuStartupEvents.registry('gtceu:material', event => {
    ...
    event.create("thorium_phosphate").dust().iconSet(GTMaterialIconSet.FINE).color(0x3B4B30).secondaryColor(0x192C20).flags(GTMaterialFlags.DECOMPOSITION_BY_CENTRIFUGING).components("1x thorium", "3x phosphate")
    ...
    event.create("thorium_pyrophosphate").dust().iconSet(GTMaterialIconSet.SHINY).color(0x709B5E).secondaryColor(0x0D5017).flags(GTMaterialFlags.DECOMPOSITION_BY_ELECTROLYZING).components("1x thorium", "2x phosphorus", "7x oxygen")
    ...
    event.create("thorium_tetrachloride").dust().iconSet(GTMaterialIconSet.SAND).color(0xA4B558).secondaryColor(0x585D1F).flags(GTMaterialFlags.DECOMPOSITION_BY_ELECTROLYZING).components("1x thorium", "4x chlorine", "1x water")
