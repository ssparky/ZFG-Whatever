ServerEvents.tags("item", event => {
    ...
    event.add("origins:food/generic_meat_raw", ["minecraft:beef", "minecraft:porkchop", "minecraft:mutton", "minecraft:chicken", "minecraft:rabbit",
        ...
        "farm_and_charm:dog_food", "kubejs:warden_heart", "tconstruct:bacon", "undergarden:raw_dweller_meat", "undergarden:raw_gwibling", "undergarden:raw_gloomper_leg",
        "infinite_abyss:eyeball_frog_meat", "twilightforest:raw_venison", "twilightforest:raw_meef", "twilightforest:hydra_chop",
        "starcatcher:geode_eel", "starcatcher:black_eel", "starcatcher:obsidian_eel", "starcatcher:molten_shrimp", "starcatcher:obsidian_crab", "starcatcher:scorched_bloodsucker",
        "starcatcher:molten_deepslate_crab", "starcatcher:cinder_squid", "starcatcher:lava_crab", "starcatcher:lava_crab_claw", "starcatcher:chorus_crab", 
        "starcatcher:obidontiee", "starcatcher:silverveil_perch", "starcatcher:elderscale", "starcatcher:driftfin", "starcatcher:twilight_koi", "starcatcher:thunder_bass",
        "starcatcher:lightning_bass", "starcatcher:sludge_catfish", "starcatcher:lily_snapper", "starcatcher:sage_catfish", "starcatcher:pale_carp", "starcatcher:pale_pinfish",
        "starcatcher:pinfish", "starcatcher:frostjaw_trout", "starcatcher:crystalback_trout", "starcatcher:aurora", "starcatcher:wintery_pike", "starcatcher:sandtail",
        "starcatcher:mirage_carp", "starcatcher:scorchfish", "starcatcher:cactifish", "starcatcher:agave_bream", "starcatcher:sunny_sturgeon", "starcatcher:rockgill",
        "starcatcher:peakdweller", "starcatcher:sun_seeking_carp", "starcatcher:blossomfish", "starcatcher:petaldrift_carp", "starcatcher:pink_koi", "starcatcher:morganite",
        "starcatcher:rose_siamese_fish", "starcatcher:vesani", "starcatcher:crystalback_sturgeon", "starcatcher:icetooth_sturgeon", "starcatcher:boreal", "starcatcher:crystalback_boreal",
        "starcatcher:silverfin_pike", "starcatcher:carpenjoe", "starcatcher:willow_bream", "starcatcher:drifting_bream", "starcatcher:downfall_bream", "starcatcher:hollowbelly_darter",
        "starcatcher:gmistback_chub", "starcatcher:bluegigi", "starcatcher:frostchill_chub", "starcatcher:crystalback_minnow", "starcatcher:azure_crystalback_minnow",
        "starcatcher:blue_crystal_fin", "starcatcher:blue_herring", "starcatcher:ironjaw_herring", "starcatcher:deepjaw_herring", "starcatcher:dusktail_snapper",
        "starcatcher:joel", "starcatcher:redscaled_tuna", "starcatcher:sea_bass", "starcatcher:bigeye_tuna", "starcatcher:shroomfish", "starcatcher:sporefish",
        "starcatcher:gold_fan", "starcatcher:whiteveil", "starcatcher:amethystback", "starcatcher:stonefish", "starcatcher:fossilized_angelfish", "starcatcher:dripfin",
        "starcatcher:yellowstone_fish", "starcatcher:lush_pike", "starcatcher:vivid_moss", "starcatcher:the_quarrish", "starcatcher:ghostly_pike", "starcatcher:aquamarine_pike",
        "starcatcher:garnet_mackerel", "starcatcher:bright_amethyst_snapper", "starcatcher:dark_amethyst_snapper", "starcatcher:deepslatefish", "starcatcher:sculkfish",
        "starcatcher:ward", "starcatcher:glowing_dark", "starcatcher:suneater", "starcatcher:pyrotrout", "starcatcher:embergill", "starcatcher:scalding_pike", "starcatcher:magma_fish",
        "starcatcher:glowstone_seeker", "starcatcher:glowstone_pufferfish", "starcatcher:willish", "starcatcher:cerberay", "starcatcher:charfish", "starcatcher:end_glow",
        "starcatcher:voidbiter", "endersdelight:mite_crust", "endersdelight:enderman_sight", "endersdelight:shulker_mollusk", "endersdelight:sight_fragments", "endersdelight:shulker_fillet",
        "rusticdelight:calamari", "rusticdelight:calamari_slice"
    ])  
    event.add("origins:food/generic_meat_cooked", ["minecraft:cooked_beef", "minecraft:cooked_porkchop", "minecraft:cooked_mutton", "minecraft:cooked_chicken",
        ...
        "brewery:pork_knuckle", "brewery:half_chicken", "undergarden:dweller_steak", "undergarden:cooked_gwibling", "undergarden:gloomper_leg",
        "infinite_abyss:eyeball_frog_meat_cooked", "twilightforest:cooked_venison", "twilightforest:cooked_meef", "starcatcher:cooked_starcaught_fish",
        "rusticdelight:cooked_calamari", "rusticdelight:cooked_calamari_slice", "rusticdelight:fried_fish"
    ])
    ...
    event.add("origins:food/generic_vegetable", ["minecraft:kelp", "minecraft:carrot", "minecraft:golden_carrot", "minecraft:potato", "minecraft:poisonous_potato", 
        ...
        "undergarden:glitterkelp", "undergarden:slop_bowl", "undergarden:gloomgourd", "infinite_abyss:cooked_puffball", "starcatcher:dried_seaweed", "endersdelight:ethereal_saffron",
        "endersdelight:amberveil_stew", "endersdelight:amberveiled_curry", "endersdelight:veil_of_flames_risotto"
    ])
    ...
    event.add("origins:food/generic_mushroom", ["minecraft:mushroom_stew", "ad_astra:aeronos_mushroom", "ad_astra:strophar_mushroom", "minecraft:red_mushroom", 
        ...
        "farmersdelight:mushroom_rice", "rusticdelight:fried_mushrooms", "kubejs:ender_spore", "regions_unexplored:blue_bioshroom", "regions_unexplored:green_bioshroom", 
        "regions_unexplored:pink_bioshroom", "regions_unexplored:yellow_bioshroom", "regions_unexplored:tall_blue_bioshroom", "regions_unexplored:tall_green_bioshroom", 
        "regions_unexplored:tall_pink_bioshroom", "regions_unexplored:tall_yellow_bioshroom", "undergarden:bloody_stew", "undergarden:inky_stew", "undergarden:indigo_stew",
        "undergarden:veiled_stew", "undergarden:indigo_mushroom", "undergarden:veil_mushroom", "undergarden:ink_mushroom", "undergarden:blood_mushroom", "undergarden:smogstem_sapling",
        "infinite_abyss:large_red_mushroom", "infinite_abyss:large_glowing_mushroom", "infinite_abyss:large_glowing_mushroom_pink", "infinite_abyss:blue_mushroom",
        "infinite_abyss:large_brown_mushroom", "infinite_abyss:green_mushroom", "infinite_abyss:medium_red_mushroom", "infinite_abyss:medium_brown_mushroom",
        "infinite_abyss:fairy_mushroom", "infinite_abyss:small_fairy_mushroom", "infinite_abyss:glowing_green_fungus", "infinite_abyss:prismashroom", "twilightforest:mushgloom",
    ...
    event.add("origins:food/generic_fruits", ["minecraft:glow_berries", "minecraft:sweet_berries", "natures_spirit:coconut", "minecraft:apple", "minecraft:golden_apple",
        ...
        "bhc:relic_apple", "regions_unexplored:salmonberry", "regions_unexplored:hanging_earlight_fruit", "regions_unexplored:duskmelon_slice", "tconstruct:jeweled_apple",
        "undergarden:droopvine_item", "undergarden:blisterberry", "deeperdarker:bloom_berries", "twilightforest:torchberries", "endersdelight:voidpepper", "endersdelight:chorusflame",
        "endersdelight:crushed_voidpepper", "endersdelight:chorus_stew", "rusticdelight:bell_pepper_orange", "rusticdelight:bell_pepper_white", "rusticdelight:bell_pepper_pink",
        "rusticdelight:bell_pepper_blue", "rusticdelight:bell_pepper_purple", "rusticdelight:bell_pepper_black", "rusticdelight:roasted_bell_pepper_orange",
        "rusticdelight:roasted_bell_pepper_pink", "rusticdelight:roasted_bell_pepper_white", "rusticdelight:roasted_bell_pepper_blue", "rusticdelight:roasted_bell_pepper_purple",
        "rusticdelight:roasted_bell_pepper_black", "rusticdelight:bell_pepper_slice_green", "rusticdelight:bell_pepper_slice_yellow", "rusticdelight:bell_pepper_slice_red",
        "rusticdelight:bell_pepper_slice_orange", "rusticdelight:bell_pepper_slice_white", "rusticdelight:bell_pepper_slice_pink", "rusticdelight:bell_pepper_slice_blue",
        "rusticdelight:bell_pepper_slice_purple", "rusticdelight:bell_pepper_slice_black", "rusticdelight:roasted_bell_pepper_slice_green", "rusticdelight:roasted_bell_pepper_slice_yellow",
        "rusticdelight:roasted_bell_pepper_slice_red", "rusticdelight:roasted_bell_pepper_slice_orange", "rusticdelight:roasted_bell_pepper_slice_white", "rusticdelight:roasted_bell_pepper_slice_pink",
        "rusticdelight:roasted_bell_pepper_slice_blue", "rusticdelight:roasted_bell_pepper_slice_purple", "rusticdelight:roasted_bell_pepper_slice_black",
        "rusticdelight:bell_pepper_roll_green", "rusticdelight:bell_pepper_roll_yellow", "rusticdelight:bell_pepper_roll_red", "rusticdelight:bell_pepper_roll_orange",
        "rusticdelight:bell_pepper_roll_pink", "rusticdelight:bell_pepper_roll_purple", "rusticdelight:bell_pepper_roll_blue", "rusticdelight:bell_pepper_roll_black", 
        "rusticdelight:bell_pepper_roll_white"   
    ])
    ...
    event.add("origins:food/generic_breads_cakes", ["minecraft:bread", "natures_spirit:whole_pizza", "minecraft:cookie", "minecraft:cake", "minecraft:pumpkin_pie",
        ...
        "create:sweet_roll", "gtceu:dough", "undergarden:gloomgourd_pie", "twilightforest:maze_wafer", "endersdelight:uncanny_cookies", "endersdelight:strange_eclair", "endersdelight:chorus_pie_slice",
        "endersdelight:chorus_pie", "endersdelight:crawling_sandwich", "rusticdelight:coffee_cheesecake", "rusticdelight:coffee_cheesecake_slice", "rusticdelight:coffee_pancakes",
        "rusticdelight:coffee_pancake"
    ])
    ...
    event.add("origins:food/generic_mixed_mostly_meat", ["oceanic_delight:seafood_skewer", "oceanic_delight:caviar_toast", "oceanic_delight:fried_shrimp", "oceanic_delight:shrimp_chips",
        ...
        "farm_and_charm:baked_lamb_ham", "farm_and_charm:stuffed_chicken", "farm_and_charm:stuffed_rabbit", "brewery:fried_chicken", "brewery:sausage", "twilightforest:meef_stroganoff",
        "endersdelight:crispy_skewer", "endersdelight:endermite_stew", "endersdelight:steak_fries", "endersdelight:chicken_curry", "endersdelight:stuffed_shulker_bowl", "endersdelight:stuffed_shulker",
        "rusticdelight:calamari_soup"
    ])
    event.add("origins:food/generic_mixed_varied", ["minecraft:rabbit_stew", "oceanic_delight:squid_salad", "oceanic_delight:caesar_salad", "oceanic_delight:takoyaki",
        ...
        "farm_and_charm:farmers_breakfast", "farm_and_charm:potato_with_roast_meat", "endersdelight:twisted_cereal", "endersdelight:pearl_pasta", "endersdelight:ender_paella",
        "rusticdelight:stuffed_bell_pepper_orange", "rusticdelight:stuffed_bell_pepper_white", "rusticdelight:stuffed_bell_pepper_pink", "rusticdelight:stuffed_bell_pepper_purple",
        "rusticdelight:stuffed_bell_pepper_blue", "rusticdelight:stuffed_bell_pepper_black", "rusticdelight:bell_pepper_medley", "rusticdelight:pale_bell_pepper_medley",
        "rusticdelight:dark_pepper_medley"
    ])
    ...
    event.add("origins:food/accesible_drinks", ["rusticdelight:coffee", "rusticdelight:chocolate_coffee", "rusticdelight:honey_coffee", "rusticdelight:syrup_coffee", 
        ...
        "brewery:whiskey_jamesons_malt", "gtceu:purple_drink", "endersdelight:chorus_juice", "rusticdelight:pumpkin_coffee", "rusticdelight:cherry_blossom_coffee"
    ])
    ...
    event.add("origins:food/other", ["mynethersdelight:tear_popsicle", "aquaculture:jellyfish", "spartanweaponry:grease_ball", "farm_and_charm:yeast",
        "undergarden:blood_globule", "twilightforest:experiment_115", "twilightforest:magic_beans"
    ])
    ...
    event.add("origins:food/centaur_grains", ["natures_spririt:lavender", "minecraft:wheat", "farmersdelight:rice_panicle", "farm_and_charm:corn", "farm_and_charm:oat", 
        ...
        "natures_spirit:oat_grass", "natures_spirit:tall_oat_grass", "regions_unexplored:barley", "regions_unexplored:meadow_sage"
    ])
    ...
    event.add("origins:food/dodo_seeds", ["minecraft:wheat_seeds", "minecraft:cocoa_beans", "minecraft:pumpkin_seeds", "minecraft:melon_seeds", "minecraft:beetroot_seeds",
        ...
        "brewery:hops_seeds", "undergarden:gloomgourd_seeds", "tconstruct:earth_slime_grass_seeds", "tconstruct:sky_slime_grass_seeds", "tconstruct:blood_slime_grass_seeds", 
        "tconstruct:ender_slime_grass_seeds", "undergarden:underbeans", "undergarden:roasted_underbeans", "rusticdelight:pale_bell_pepper_seeds", "rusticdelight:dark_bell_pepper_seeds"
    ])
    event.add("origins:food/dodo_seeds", /^dynamictrees:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^dynamictreesplus:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^dtnatures_spirit:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^dttwilight_forest:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^dtru:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^dttconstruct:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_seeds", /^rubberdt:[a-z0-9]+(?:_+[a-z0-9]+)*_seed$/)
    event.add("origins:food/dodo_misc", ["aquaculture:worm", "starcatcher:worm", "starcatcher:almighty_worm", "starcatcher:seeking_worm", "starcatcher:dev_worm"])
})