ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("kubejs:ef/mega_chem_reactor")
        ...
        .inputFluids("gtceu:polytetrafluoroethylene 2880", "gtceu:polycaprolactam 1440")
    ...
    // TODO Large Fusion Reactors (what to scan?)
    ...
    event.recipes.gtceu.assembler("kubejs:ef/luv_wireless_data_trans")
        ...
        .itemOutputs("extendedfeatures:luv_wireless_data_transmitter")
        .duration(200)
        .circuit(1)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.assembler("kubejs:ef/luv_wireless_data_receiv")
        ...
        .inputFluids("gtceu:vibrant_alloy 576")
        .itemOutputs("extendedfeatures:luv_wireless_data_receiver")
        .duration(200)
        .circuit(2)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.assembler("kubejs:ef/zpm_wireless_data_trans")
        ...
        .itemOutputs("extendedfeatures:zpm_wireless_data_transmitter")
        .duration(200)
        .circuit(1)
        .EUt(GTValues.VA[GTValues.UV])
    event.recipes.gtceu.assembler("kubejs:ef/zpm_wireless_data_receiv")
        ...
        .inputFluids("gtceu:vibrant_alloy 1152")
        .itemOutputs("extendedfeatures:zpm_wireless_data_receiver")
        .duration(200)
        .circuit(2)
        .EUt(GTValues.VA[GTValues.UV])
    event.recipes.gtceu.assembler("kubejs:ef/uv_wireless_data_trans")
        ...
        .itemOutputs("extendedfeatures:uv_wireless_data_transmitter")
        .duration(200)
        .circuit(1)
    ...
    event.recipes.gtceu.assembler("kubejs:ef/uv_wireless_data_receiv")
        ...
        .inputFluids("gtceu:vibrant_alloy 2304")
        .itemOutputs("extendedfeatures:uv_wireless_data_receiver")
        .duration(200)
        .circuit(2)
        .EUt(GTValues.VA[GTValues.UHV])
